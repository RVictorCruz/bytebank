...
class Endereco(
    ...
    override fun toString(): String { //sobreescrita de método
        return """ //Raw String
            ...
            estado='$estado',
            cep='$cep',
            complemento='$complemento')""".trimIndent() //O texto será formatado no formato que é colocado aqui
    }
    ...
    fun completo(): String {
        return """
Localização: $logradouro - $numero, $bairro, $cidade - $estado
Cep: $cep
